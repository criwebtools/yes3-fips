...
class Yes3 {
   ...
   static function helloWorld() {
    ...
    // the framework version of this function crashes (v12)
    
    /**
     * @return ((int|string)|mixed)[]
     */
    public static function getFormsForEventId($eventId)
    {
        $result = self::query('select form_name from redcap_events_forms where event_id = ?', $eventId);
